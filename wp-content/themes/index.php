			...
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-sm-2 col-xs-12">
						<div id="gtco-logo"> <img src="images/vidrotemp-logo.png"></div>
					</div>
			...
			<div class="gtco-container">
				<div class="row">
					...
					<div class="col-md-5 col-md-push-1 gtco-testimonials">
						<h2>Testimonios</h2>
						<blockquote>
							<p>Desde que ocupo Vidrotemp mi vida ha cambiado, todo es muchísimo más claro</p>
							<p class="author"><cite>&mdash;  (Billy Puertitas).</cite></p>
						</blockquote>
						<blockquote>
							<p>Yo no sé qué haría sin los vidrios templados de Vidrotemp, ahora soy muchísimo más feliz</p>
